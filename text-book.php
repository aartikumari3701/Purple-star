<?php
session_start();// Include database connection and header
...
<head>
    ...
    <meta name="description" content="Explore a wide variety of textbooks on different topics and disciplines.">
